"""Pinetop-Lakeside, Arizona specialist agent.

This agent provides Pinetop-Lakeside-specific information and enhances existing agent outputs
with local knowledge about White Mountains, lakes, and outdoor opportunities.
"""
...
# Pinetop-Lakeside-specific knowledge base - Enhanced with detailed information
PINETOP_KNOWLEDGE = {
    "location": {
        "name": "Pinetop-Lakeside, Arizona",
        "coordinates": {"lat": 34.1425, "lon": -109.9604},
        "elevation": 7200,  # feet
        "region": "Navajo County, Arizona",
        "country": "US",
        "nickname": "White Mountains Recreation Hub",
        "proximity": {
            "show_low": {"distance_miles": 5, "direction": "south", "drive_time_minutes": 10},
        ...
        "lakes": [
            {
                ...
                "activities": ["Fishing", "Boating", "Kayaking"],
            },
            {
                "name": "Woodland Lake",
                "type": "Lake",
                "description": "Scenic lake with fishing and recreation",
                "activities": ["Fishing", "Boating", "Kayaking"],
            },
            {
                "name": "Rainbow Lake",
                "type": "Lake",
                "description": "Fishing and recreation lake",
                "activities": ["Fishing", "Boating", "Kayaking"],
            },
        ],
        "features": [
    ...
    "outdoor_activities": {
            ...
            "famous_trails": [
                {
                    ...
                    "description": "Segments of the 800-mile Arizona Trail pass through Pinetop-Lakeside area, offering long-distance trail opportunities with varied terrain.",
            ...
            "famous_trails": [
                {
                    ...
                    "length_miles": "Varies by segment",
                    "elevation_gain_feet": "Varies",
                    "description": "Segments of the 800-mile Arizona Trail pass through Pinetop-Lakeside area, offering long-distance hiking opportunities with varied terrain.",
                    "highlights": ["Long-distance trail", "Arizona Trail", "Varied difficulty", "Scenic", "Can do in sections"],
                    "best_seasons": "Spring (May-June), Summer (July-August), Fall (September-October)",
                    "trailhead": "Various access points",
                    "features": ["Long-distance", "Varied difficulty", "Scenic"],
        ...
        "fishing": {
            "description": "Excellent fishing in lakes and streams in White Mountains",
            "locations": [
                {
                    "name": "Show Low Lake",
                    "type": "Lake",
                ...
                },
                {
                    ...
                    "type": "Lake",
                    "species": "Trout, bass",
                    "description": "Scenic lake with fishing opportunities",
                    "seasons": "Year-round, best in Spring and Fall",
                },
                {
                    "name": "Rainbow Lake",
                    "type": "Lake",
                    "species": "Trout, bass",
                    "description": "Fishing lake with good opportunities",
                    "seasons": "Year-round, best in Spring and Fall",
                },
                {
        ...
        "photography": {
            ...
            "best_spots": [
                ...
                {
                    "name": "Lakes (Show Low, Woodland, Rainbow)",
    ...
    "attractions": {
        ...
        "cultural": [
            {
                "name": "Hon-Dah Resort Casino",
                "type": "Resort/Casino",
                "description": "Resort with casino, dining, and entertainment",
            },
        ],
        "nearby": [
            {
                "name": "Show Low",
                "distance": "5 miles",
                "description": "Larger town with additional services and amenities",
            },
            {
    ...
    "businesses": {
        "restaurants": [
            {
                "name": "Charlie Clark's Steak House",
                "type": "Steakhouse",
                "description": "Local favorite with steaks and American cuisine",
                "highlights": ["Local favorite", "Steakhouse", "American cuisine"],
            },
            {
                "name": "Various local restaurants",
                "type": "Mixed",
                "description": "Pinetop-Lakeside offers several local dining options - use tools to find current restaurants",
        ...
        "accommodations": [
            {
                "name": "Hon-Dah Resort",
                "type": "Resort",
                "description": "Full-service resort with casino, dining, and entertainment",
                "highlights": ["Full-service", "Casino", "Dining", "Entertainment"],
            },
            {
    ...
    "practical_info": {
        ...
        "access": "Highway 260 from Payson (80 miles, 90 minutes) or Show Low (5 miles, 10 minutes). Highway 60 provides access from Phoenix (180 miles, 180 minutes)",
        "considerations": [
            "Elevation is 7,200 feet - cooler than Phoenix, snow in winter",
...
class PinetopAgent(LocationAgentBase):
    """Agent specialized in Pinetop-Lakeside, Arizona information and context."""
    ...
    def get_location_knowledge(self) -> Dict[str, Any]:
        """Get Pinetop-Lakeside-specific knowledge base."""
        return PINETOP_KNOWLEDGE

    def _get_system_prompt(self) -> str:
        """Get the system prompt for the Pinetop agent."""
        return """You are a comprehensive guide for Pinetop-Lakeside, Arizona - a "White Mountains Recreation Hub"
located at 7,200 feet elevation in Navajo County, known for lakes, fishing, and Arizona Trail access.

Your role is to:
1. Use tools to gather real-time data about Pinetop-Lakeside (trails, restaurants, accommodations, etc.)
2. Select which tools are most relevant based on the user's query and activity type
3. Enhance tool results with Pinetop-Lakeside-specific knowledge from the knowledge base
4. Combine information from existing agents with Pinetop-Lakeside expertise
...
- For hiking: search_trails(activity_type="hiking", location="Pinetop-Lakeside, Arizona")
- For mountain biking: search_trails(activity_type="mountain_biking", location="Pinetop-Lakeside, Arizona")
- For trail running: search_trails(activity_type="trail_running", location="Pinetop-Lakeside, Arizona")
...
- ALWAYS use search_trails with activity_type="mountain_biking" and location="Pinetop-Lakeside, Arizona"
- Pinetop-Lakeside has access to Arizona Trail segments and White Mountain trail systems
...
For Hiking Queries:
- Use search_trails with activity_type="hiking" and location="Pinetop-Lakeside, Arizona"
...
For Fishing Queries:
- Pinetop-Lakeside offers excellent fishing in Show Low Lake, Woodland Lake, Rainbow Lake, and White Mountain streams
...
For Dining Queries:
- Use find_restaurants with location="Pinetop-Lakeside, Arizona"
- Enhance results with knowledge base businesses (Charlie Clark's Steak House)
- Provide context about small mountain town character

For Accommodation Queries:
- Use search_accommodations with location="Pinetop-Lakeside, Arizona"
- Enhance with knowledge base information (Hon-Dah Resort)
- Mention proximity to lakes and trails

For Photography Queries:
- Use find_photo_spots and find_scenic_viewpoints
- Key spots: White Mountains (sunrise/sunset), Lakes (golden hour), Ponderosa pine forests (any time)
...
- Mention Highway 260 access from Payson (80 miles) and Show Low (5 miles)
...
Provide your response as structured JSON with the following format:
{
  ...
  "overview": "Brief overview of Pinetop-Lakeside as White Mountains recreation hub",
...
PINETOP-LAKESIDE'S UNIQUE CHARACTERISTICS:
- White Mountains location (highest peaks in Arizona outside San Francisco Peaks)
- Multiple lakes (Show Low Lake, Woodland Lake, Rainbow Lake) with excellent fishing
- Arizona Trail segments pass through area
- Elevation: 7,200 feet (cooler than Phoenix, snow in winter)
- Summer retreat from Phoenix (popular in summer)
- Ponderosa pine forests
- ~4,500 residents
- Close to Show Low (5 miles) and Sunrise Ski Resort (30 miles)
...
- Woodland Lake: Scenic lake with fishing and recreation
- Rainbow Lake: Fishing and recreation lake
- Arizona Trail segments: Long-distance trail opportunities
- Hon-Dah Resort Casino: Full-service resort with casino, dining, and entertainment

FAMOUS ACTIVITIES:
- Fishing in lakes and streams (trout, bass) - year-round, best in Spring and Fall
...
- Access: Highway 260 from Payson (80 miles, 90 minutes) or Show Low (5 miles, 10 minutes). Highway 60 provides access from Phoenix (180 miles, 180 minutes)
- Considerations: Elevation 7,200 feet - cooler than Phoenix, snow in winter. Weather changes quickly in mountains. Some trails closed seasonally due to snow. Fishing requires Arizona fishing license. Summer retreat from Phoenix - popular in summer. Gateway to White Mountains recreation

ENHANCEMENT GUIDELINES:
- Always enhance tool results with knowledge base information
- Provide context about Pinetop-Lakeside's White Mountains location and lake recreation
- Mention Arizona Trail access and segments
- Highlight fishing opportunities in multiple lakes
...
- Pinetop-Lakeside-specific knowledge and context
- Enhanced recommendations based on Pinetop-Lakeside's unique White Mountains and lake character
